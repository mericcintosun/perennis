...
8. **`/`** The landing page, an editorial page rather than a dashboard. It opens
   on the masthead: the claim "Hold a view for four hours. Sign once." set in the
   ...
   a full page screenshot because nothing on this page starts hidden.
